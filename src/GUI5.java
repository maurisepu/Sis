...
public class GUI5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Sí, Usted tendrá el Derecho que despues de 30 días de la confirmación");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/tratamiento.png"))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 24)); // NOI18N
        jLabel3.setText("¿Y tengo derecho a tratamiento?");

        jLabel4.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 24)); // NOI18N
        jLabel4.setText(" debe exigir el comenzar a recibir tratamiento.");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        system = InfoAuge.getSystem();
        system.esconde();
        system.getFondo6().setVisible(true);
